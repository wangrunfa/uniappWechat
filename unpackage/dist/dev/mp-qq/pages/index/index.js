...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var history = function history() {return __webpack_require__.e(/*! import() | conponents/history */ "conponents/history").then(__webpack_require__.bind(null, /*! ../../conponents/history.vue */ 23));};
...

{
  ...
  methods: {
    ...
    clickDownloadImage: function clickDownloadImage(e, currentIndex, path) {
      console.log(e);
      console.log(path);
      ...
      for (var i = 0; i < array.length; i++) {
        ...
        if (e.detail.x < 200 && currentIndex == i) {
          ...
          var setdownloads = "";
          var plusone = this.tripsReight[currentIndex].downloads + 1;
          this.tripsLeft[currentIndex].testDisabled = 1;
          this.tripsLeft[currentIndex].downloads = plusone;
          console.log(plusone + "aaaaaaaaaaaaaaa");
        }
        if (e.detail.x > 200 && currentIndex == i) {
          var setDisableds = "tripsReight[" + currentIndex + "].testDisabled";
          var setdownloads = "tripsReight[" + currentIndex + "].downloads";
          var plusone = this.tripsReight[currentIndex].downloads + 1;
          this.setDisableds = "1";
          this.setdownloads = plusone;
          console.log(this.setDisableds + " *-------------console.log(this.setDisableds) ");
        }
      ...
      //     uni.request({
      //       url: app.globalData.apiPaths + '/downloadsPlusOne',
      //       method: 'GET',
      //       headers: {
      //         'Content-Type': 'application/json'
      //       },
      //       data: {
      //         idExpressions: e.currentTarget.dataset.ide
      //       },


      //     })
      //     let currentIndex = e.currentTarget.dataset.index
      //     var array = this.data.tripsLeft;
      //    for(var i=0;i<array.length;i++){
      //      if (e.detail.x < 200 && currentIndex == i) {
      //        var setDisableds = "tripsLeft[" + currentIndex + "].testDisabled";
      //        var setdownloads = "tripsLeft[" + currentIndex + "].downloads";
      //        var plusone = this.tripsReight[currentIndex].downloads + 1;
      //          setDisableds="1";
      //          setdownloads= plusone;
      //      }
      //      if (e.detail.x > 200 && currentIndex == i) {
      //        var setDisableds = "tripsReight[" + currentIndex + "].testDisabled";
      //        var setdownloads = "tripsReight[" + currentIndex + "].downloads";
